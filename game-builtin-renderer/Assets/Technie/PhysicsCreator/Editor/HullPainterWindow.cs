	...
	public class HullPainterWindow : EditorWindow
	{
		...
		private void DrawDimmingSettings(float[] collumnWidths)
		{
			GUILayout.BeginHorizontal();
			{
				...
				this.dimFactor = GUILayout.HorizontalSlider(this.dimFactor, 0.0f, 1.0f);
				GUI.enabled = true;
		...
		public void AdvanceBrushSize()
		{
			...
			{
				PaintingBrush brush = sceneManipulator.GetCurrentBrush();
				...
				sceneManipulator.SetBrush(brush);
			}
		}
		...
		{
			return FindAssetPath<PhysicsCreatorHullFolder>("");
		}
